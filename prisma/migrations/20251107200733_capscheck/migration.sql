/*
  ...
  - The values [applescript,cpp,csharp] on the enum `Skills` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "Skills_new" AS ENUM ('other', 'programming', 'scripting', 'AppleScript', 'Arduino', 'Assembly', 'Batch', 'Bootstrap', 'C', 'C++', 'CryEngine', 'C#', 'CSS', 'FORTRAN', 'GameMaker', 'Godot', 'HTML', 'Java', 'JS', 'Lisp', 'Lumberyard', 'MATLAB', 'NextJS', 'Pascal', 'Perl', 'PHP', 'Python', 'R', 'React', 'RenPy', 'Ruby', 'Rust', 'Scratch', 'SQL', 'Swift', 'Torque', 'TS', 'Unity', 'Unreal', 'XML');
